...
- (void)findNext {
    [self stringByEvaluatingJavaScriptFromString:@"findNext()"];
}

- (void)findPrevious {
    [self stringByEvaluatingJavaScriptFromString:@"findPrevious()"];
}

- (void)removeAllHighlights {
    [self stringByEvaluatingJavaScriptFromString:@"findDone()"];
}
