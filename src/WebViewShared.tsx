...
export const useWebWiewLogic = ({
  ...
  onShouldCreateNewWindowProp?: OnShouldCreateNewWindow;
  onCaptureScreenProp?: (event: WebViewMessage) => void;
}) => {
  ...
  */
  const onCreateNewWindow = useCallback((event: WebViewNavigationEvent)=>{
    onShouldCreateNewWindowProp?.(event.nativeEvent)
  }, [onShouldCreateNewWindowProp])

  const onCaptureScreen = useCallback((event: WebViewMessageEvent)=>{
    onCaptureScreenProp?.(event.nativeEvent)
  }, [onCaptureScreenProp])
