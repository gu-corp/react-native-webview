...
public class Engine {
    ...
    private static native BlockerResult engineMatch(long engine, String url, String host, String tabHost, boolean thirdParty, String resourceType);
    ...
    public BlockerResult match(String url, String host, String tabHost, boolean thirdParty, String resourceType) {
