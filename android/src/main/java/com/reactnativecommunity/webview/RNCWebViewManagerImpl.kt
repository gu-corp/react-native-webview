...
class RNCWebViewManagerImpl {
  ...
  // region valiable custom for lunascape
  ...
  protected fun createNewWindow(reactContext: ThemedReactContext?): RNCWebView {
    val newView = RNCWebView.createNewWindow(reactContext)
    // TODO task @01fc6c
//        newView.addJavascriptInterface(
//            newView.createRNCNativeWebViewBridge(newView),
//            NATIVE_SCRIPT_INTERFACE
//        )
