...
public class RNCWebViewManager extends ViewGroupManager<RNCWebViewWrapper>
  ...
  @Override
    protected void addEventEmitters(@NonNull ThemedReactContext reactContext, RNCWebViewWrapper view) {
        ...
        RNCWebView rncWebView = view.getWebView();
    ...
    public Map<String, Object> getExportedCustomDirectEventTypeConstants() {
        ...
        export.put(TopUpdateHistoryEvent.EVENT_NAME, MapBuilder.of("registrationName", "onUpdateHistory"));
        return export;
    }
    ...
    @Override
    public void requestWebFavicon(RNCWebViewWrapper view) {}
